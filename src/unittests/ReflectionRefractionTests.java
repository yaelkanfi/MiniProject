		...
		scene.geometries.add(
				...
				new Sphere( new Point3D(0, 40, -100), 40) // the center sphere-head
						...
						new Sphere( new Point3D(-95, 70, -120),20) // the center sphere- baloon
						 ...
						 new Triangle(new Point3D(-70, 42, 95), new Point3D(-67, 42, 115), new Point3D(-50,-5, 130)).setEmmission(new Color(java.awt.Color.RED)).setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(30)), //triangle of nose
						 ...
						 new Sphere( new Point3D(-15, -40, -65), 18) // the center sphere-  left heart
							...
							.setEmmission(new Color(java.awt.Color.RED)),
							 new Triangle(new Point3D(-28.7,-44.5, 95), new Point3D(28.6, -44.5, 115), new Point3D(0, -63, 130)).setEmmission(new Color(java.awt.Color.RED)),//.setMaterial(new Material().setkD(0.25).setkS(0.25).setnShininess(20).setkT(0).setkR(0.8)),//.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(30)), //triangle of nose	
